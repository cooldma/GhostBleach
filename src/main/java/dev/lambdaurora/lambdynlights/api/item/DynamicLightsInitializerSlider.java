...
public class DynamicLightsInitializerSlider extends ModuleDynamicLightsInitializer<Double> {

	public double min;
	public double max;
	public int decimals;

	public DynamicLightsInitializerSlider(String text, double min, double max, double value, int decimals) {
		super(text, value, DynamicLightHandler.DOUBLE);
		this.min = min;
		this.max = max;
	...
	public DynamicLightsInitializerSlider withDesc(String desc) {
		setTooltip(desc);
		return this;
	}
