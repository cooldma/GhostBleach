...
public class DynamicLightsInitializerColor extends ModuleDynamicLightsInitializer<float[]> {

	public DynamicLightsInitializerColor(String text, int r, int g, int b) {
		super(text, rgbToHsv(r, g, b), float[]::clone, DynamicLightHandler.FLOAT_ARRAY);
	}
	...
	public DynamicLightsInitializerColor withDesc(String desc) {
		setTooltip(desc);
		return this;
	}
