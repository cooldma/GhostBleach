...
import dev.lambdaurora.lambdynlights.gui.window.WindowScreen;
import dev.lambdaurora.lambdynlights.gui.window.widget.WindowButtonWidget;
import dev.lambdaurora.lambdynlights.gui.window.widget.WindowScrollbarWidget;
import dev.lambdaurora.lambdynlights.gui.window.widget.WindowTextFieldWidget;
import dev.lambdaurora.lambdynlights.api.DynamicLightHandlers;
import dev.lambdaurora.lambdynlights.api.DynamicLightHandler;

import java.util.*;

public abstract class DynamicLightsInitializerList<T> extends ModuleDynamicLightsInitializer<LinkedHashSet<T>> {

	protected String windowText;
	protected Set<T> itemPool;

	@SuppressWarnings("unchecked")
	public DynamicLightsInitializerList(String text, String windowText, DynamicLightHandlers<T> itemHandler, Collection<T> itemPool, T... defaultItems) {
		super(text, new LinkedHashSet<>(Arrays.asList(defaultItems)), v -> (LinkedHashSet<T>) v.clone(), DynamicLightHandler.ofCollection(itemHandler, LinkedHashSet::new));
	...
	public DynamicLightsInitializerList<T> withDesc(String desc) {
		setTooltip(desc);
		return this;
	}
