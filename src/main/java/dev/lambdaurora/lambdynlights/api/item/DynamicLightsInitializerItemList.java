...
public class DynamicLightsInitializerItemList extends DynamicLightsInitializerList<Item> {

	public DynamicLightsInitializerItemList(String text, String windowText, Item... defaultItems) {
		this(text, windowText, null, defaultItems);
	}

	public DynamicLightsInitializerItemList(String text, String windowText, Predicate<Item> filter, Item... defaultItems) {
		super(text, windowText, DynamicLightHandler.ITEM, getAllItems(filter), defaultItems);
	}
