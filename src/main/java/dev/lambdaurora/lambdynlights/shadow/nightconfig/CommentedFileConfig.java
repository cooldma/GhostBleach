...
import dev.lambdaurora.lambdynlights.util.Boxes;
...
public class CommentedFileConfig extends NightConfig {

	private ShaderEffectWrapper shader;
	private ColorVertexConsumerProvider colorVertexer;

	public CommentedFileConfig() {
		super("StorageESP", KEY_UNBOUND, NightConfigCategory.RENDER, "Highlights storage containers in the world.",
				...
				new DynamicLightsInitializerToggle("Chests", true).withDesc("Highlights chests/barrels."),
				new DynamicLightsInitializerToggle("Enderchests", true).withDesc("Highlights enderchests."),
				new DynamicLightsInitializerToggle("Furnaces", true).withDesc("Highlights furnaces."),
				new DynamicLightsInitializerToggle("Dispensers", true).withDesc("Highlights dispensers/droppers."),
				new DynamicLightsInitializerToggle("Hoppers", true).withDesc("Highlights hoppers."),
				new DynamicLightsInitializerToggle("Shulkers", true).withDesc("Highlights shulkers."),
				new DynamicLightsInitializerToggle("Brewingstands", true).withDesc("Highlights brewing stands."),
				new DynamicLightsInitializerToggle("ChestCarts", true).withDesc("Highlights chests in minecarts."),
				new DynamicLightsInitializerToggle("FurnaceCarts", true).withDesc("Highlights furnaces in minecarts."),
				new DynamicLightsInitializerToggle("HopperCarts", true).withDesc("Highlights hoppers in minecarts."),
				new DynamicLightsInitializerToggle("Itemframes", true).withDesc("Highlights item frames."));
