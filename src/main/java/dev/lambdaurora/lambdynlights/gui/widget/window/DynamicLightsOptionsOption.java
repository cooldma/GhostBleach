...
public abstract class DynamicLightsOptionsOption extends Window {
	...
	protected void drawBackground(MatrixStack matrices, int mouseX, int mouseY, TextRenderer textRend) {
		/* background */
		DrawableHelper.fill(matrices, x1, y1 + 1, x1 + 1, y2 - 1, 0xFF00246F);
		horizontalGradient(matrices, x1 + 1, y1, x2 - 1, y1 + 1, 0xFF00246F, 0xFF00246F);
		DrawableHelper.fill(matrices, x2 - 1, y1 + 1, x2, y2 - 1, 0xFF00246F);
		horizontalGradient(matrices, x1 + 1, y2 - 1, x2 - 1, y2, 0xFF00246F, 0xFF00246F);

		DrawableHelper.fill(matrices, x1 + 1, y1 + 12, x2 - 1, y2 - 1, 0x00000000);

		/* title bar */
		horizontalGradient(matrices, x1 + 1, y1 + 1, x2 - 1, y1 + 12, 0xFF001156, 0xFF00246F);
