...
public class FileMang {
	...
	public static void init() {
		dir = Paths.get(MinecraftClient.getInstance().runDirectory.getPath(), "Classes1.8.9\\lunar\\ah");
...
//			Logger.logger.error("Error Reading File: " + path, e);
		}
...
//			Logger.logger.error("Error Creating File: " + path, e);
		}
	}
...
//			Logger.logger.error("Error Clearing/Creating File: " + path, e);
		}
	}
...
//			Logger.logger.error("Error Appending File: " + path, e);
		}
	}
...
//			Logger.logger.error("Error Deleting File: " + path, e);
		}
	}
}
