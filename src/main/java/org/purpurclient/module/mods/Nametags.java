...
import org.purpurclient.util.render.WorldRenderer;
...
//			mainText.add(((MutableText) player.getName()).formatted(PurpurClient.friendMang.has(player) ? Formatting.AQUA : Formatting.RED));
		}
