 ...
 */
package org.purpurmc.purpur.client.gui.clickgui;
...
//		textRenderer.draw(matrices, "PurpurClient-" + PurpurClient.VERSION + "-" + SharedConstants.getGameVersion().getName(), 3, 3, 0x305090);
//		textRenderer.draw(matrices, "PurpurClient-" + PurpurClient.VERSION + "-" + SharedConstants.getGameVersion().getName(), 2, 2, 0x6090d0);
		textRenderer.draw(matrices, "GhostBleach", 3, 3, 0x305090);
		textRenderer.draw(matrices, "GhostBleach", 2, 2, 0x6090d0);
