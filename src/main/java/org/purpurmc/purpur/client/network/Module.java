...
import org.purpurmc.purpur.client.setting.module.SettingKey;
...
public class Module {
	...
	public Module(String name, int key, ModuleCategory category, boolean enabled, String desc, ModuleSetting<?>... settings) {
		...
		this.key = new SettingKey(key).withDesc("The bind for this network, press [DELETE] to unbind.");
	...
	public void onEnable(boolean inWorld) {
		...
		subscribed = PurpurClient.eventBus.subscribe(this);
	}

	public void onDisable(boolean inWorld) {
		if (subscribed) {
			PurpurClient.eventBus.unsubscribe(this);
		}
