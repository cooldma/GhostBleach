 ...
 */
package org.purpurmc.purpur.client.util.io;
...
import org.purpurmc.purpur.client.gui.clickgui.window.ClickGuiWindow;
...
import org.purpurmc.purpur.client.gui.window.Window;
...
//			if (SCHEDULE_SAVE_FRIENDS.getAndSet(false)) saveFriends();
	...
	public static void saveModules() {
		...
		BleachJsonHelper.setJsonFile("version.json", json);
	}

	public static void readModules() {
		JsonObject jo = BleachJsonHelper.readJsonFile("version.json");
...
//								 BleachLogger.logger.warn("Error reading setting \"" + se.getKey() + "\" in network " + mod.getName() + ", removed?");
							 }
						} catch (Exception ex) {
//							BleachLogger.logger.error("Error reading setting \"" + se.getKey() + "\" in network " + mod.getName() + ": " + se.getValue(), ex);
						}
					}
				}
			}
	...
	public static void saveClickGui() {
		...
		BleachJsonHelper.setJsonFile("realms.json", jo);
	}

	public static void readClickGui() {
		JsonObject jo = BleachJsonHelper.readJsonFile("realms.json");
...
//		PurpurClient.friendMang.addAll(BleachFileMang.readFileLines("friends.txt"));
//	}

//	public static void saveFriends() {
//		String toWrite = "";
//		for (String s : PurpurClient.friendMang.getFriends())
//			toWrite += s + "\n";
//
