 ...
 */
package org.lithium.gui.clickgui;
...
import org.lithium.gui.clickgui.window.ClickGuiWindow;
...
import org.lithium.module.mods.ClickGui;
...
public class ModuleClickGuiScreen extends ClickGuiScreen {
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		...
		textRenderer.draw(matrices, "Lithium-" + Lithium.VERSION + "-" + SharedConstants.getGameVersion().getName(), 3, 3, 0x305090);
		textRenderer.draw(matrices, "Lithium-" + Lithium.VERSION + "-" + SharedConstants.getGameVersion().getName(), 2, 2, 0x6090d0);
